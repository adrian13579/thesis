...
\title{Construcción de una base wavelet ortogonal y discreta para la detección de patrones en mamografías}
\author{\\\vspace{0.25cm}Adrian Rodriguez Portales}
\advisor{\\\vspace{0.25cm}MSc. Damián Valdés Santiago}
